...
class PDFGeneratorUGPage extends StatefulWidget {
  final String name, rollNo, department, hostelBlock, days, leaveStartDate,
      leaveEndDate, natureOfLeave, reason, address, mobile;

  const PDFGeneratorUGPage({
    super.key,
    required this.name,
  ...
  @override
  _PDFGeneratorUGPageState createState() => _PDFGeneratorUGPageState();
}

class _PDFGeneratorUGPageState extends State<PDFGeneratorUGPage> {
  Uint8List? pdfData;
  ...
  pw.Widget _buildFormTitle() {
    return pw.Column(
      children: [
        ...
        pw.Center(
          child: pw.Text(
            'Student Leave Application Form (for UG)',
            style: pw.TextStyle(
              fontSize: 12,
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          _buildField('9. Mobile No. : ', widget.mobile, pageWidth),
        ],
      ),
    );
  }
  ...
  pw.Widget _buildSignatureAssisatant() {
    return pw.Column(
      children: [
        pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.end, // Aligns text to the right
  ...
  pw.Widget _buildField(String label, String value, double maxWidth) {
    return pw.Container(
      width: maxWidth,
            ...
            child: pw.Stack(
              ...
              children: [
                ...
                pw.Align(
                  ...
                  child: pw.Text(value, style: pw.TextStyle(font: ttfRegular, fontSize: 14)),
                ),
              ],
            ),
          ),
