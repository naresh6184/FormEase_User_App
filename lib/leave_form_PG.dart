...
import 'generate_form_PG.dart';
import 'themed_scaffold.dart';
import 'package:http/http.dart' as http;

class LeaveApplicationFormPG extends StatefulWidget {
  const LeaveApplicationFormPG({super.key});

  @override
  _LeaveApplicationFormPGState createState() => _LeaveApplicationFormPGState();
}
...
class _LeaveApplicationFormPGState extends State<LeaveApplicationFormPG> {
  ...
  void _validateForm() {
    setState(() {
      ...
      if (emailController.text.isEmpty) errorMessages.add('Please enter your College Email Id');
    });
  }
  ...
  Widget build(BuildContext context) {
    return ThemedScaffold(
      appBar: AppBar(
        title: const Text('Leave Application for PG'),
            ...
            child: Form(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _buildFormField('Name:', nameController,readOnly: true),
                    ...
                    const SizedBox(height: 15),
                    _buildFormField('College Email Id:', emailController, keyboardType: TextInputType.emailAddress),
        ...
        onPressed: () {
          ...
          if (errorMessages.isEmpty) {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PDFGeneratorPGPage(
